  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>GİDERLER</Text>
        <TouchableOpacity 
          hitSlop={12} 
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.emptySubtitle}>Eklediğiniz giderler burada listelenecektir.</Text>
      </View>
      ...
      <View style={styles.footer}>
        ...
        >
          <Text style={styles.primaryButtonText}>YENİ GİDER EKLE</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
