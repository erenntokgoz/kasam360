...
const styles = StyleSheet.create({
  ...
  rowName: { fontFamily: 'System', fontSize: 15, marginBottom: 2 },
  rowDue: { fontFamily: 'System', fontSize: 11, marginBottom: 6 },
  ...
  modalAmountLabel: { fontFamily: 'System', fontSize: 13 },
  modalAmountVal: { fontFamily: 'System', fontSize: 22 },
  modalInputWrap: { flexDirection: 'row', alignItems: 'center', borderRadius: 10, paddingHorizontal: 12, marginBottom: 32 },
  modalCurrency: { fontFamily: 'System', fontSize: 22, marginRight: 8 },
  modalInput: { flex: 1, fontFamily: 'System', fontSize: 28, paddingVertical: 12 },
  modalActions: { flexDirection: 'row', gap: 16 },
  modalBtn: { flex: 1, height: 48, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  modalBtnText: { fontFamily: 'System', fontSize: 15 },
  modalCancel: { marginTop: 24, alignItems: 'center' },
  modalCancelText: { fontFamily: 'System', fontSize: 13 },
});
