      ...
      >
        ...
        >
          <View style={styles.logoCircle}>
            <Icon name="shield" size={32} color={theme.colors.accent} />
          </View>
          <Text style={styles.brandName}>KASAM360</Text>
          <Text style={styles.brandSubtitle}>Güvenli İşletme Yönetimi</Text>
        </Animated.View>
        ...
        >
          ...
          >
            {isLoading ? (
              ...
              <Text style={styles.submitLabel}>GİRİŞ YAP</Text>
            )}
          </Pressable>
